...
Deno.serve(async (req) => {
  ...
  try{
    ...
    const clean=bereinigeZutaten(vorschlag.zutaten??[], body.schlank===true);vorschlag.zutaten=clean.zutaten;vorschlag.wirkstoffe=bereinigeWirkstoffe(vorschlag.wirkstoffe??[]);try{vorschlag.mikronaehrstoffe_100g=bereinigeMikro100(vorschlag.mikronaehrstoffe_100g??[]);}catch{vorschlag.mikronaehrstoffe_100g=[];}
